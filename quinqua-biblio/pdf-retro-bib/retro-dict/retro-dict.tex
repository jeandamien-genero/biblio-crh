...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les articles de dictionnaire écrits par les membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
