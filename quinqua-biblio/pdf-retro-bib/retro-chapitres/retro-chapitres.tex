...
\title{Bibliographie rétrospective du CRH (chapitres d'ouvrage)}
...
\begin{center}
	\begin{itshape}
				...
				Ce document \LaTeX{} présente les chapitres d'ouvrage écrits par les membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
...
\section{Introduction, présentation, conclusion}
\printbibliography[heading=subbibliography,keyword=intro-book-crh,heading=none]

\newpage

\section{Articles dans des actes de colloque}
\printbibliography[heading=subbibliography,keyword=chapitre,heading=none]

\newpage

\section{Contributions dans un livre collectif}
\printbibliography[heading=subbibliography,keyword=collectif-crh,heading=none]

\newpage

\section{Contributions dans des Mélanges}
\printbibliography[heading=subbibliography,keyword=melanges-crh,heading=none]
