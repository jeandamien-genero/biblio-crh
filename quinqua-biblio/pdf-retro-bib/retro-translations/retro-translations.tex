...
% BIB SOURCE
\addbibresource{../translations.bib}
...
\title{Bibliographie rétrospective du CRH (traductions)}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les traductions publiées par les membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
