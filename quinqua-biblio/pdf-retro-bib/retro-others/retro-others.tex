...
\title{Bibliographie rétrospective du CRH (autres)}
...
\begin{titlepage}
	\begin{center}
		...
		\begin{Huge}
			...
			\textbf{Autres publications scientifiques}
		\end{Huge}
...
\begin{center}
	\begin{itshape}
				...
				Ce document \LaTeX{} présente les catalogues d'exposition, outils pour la recherches, rapports et articles dans des rapports, conférences et thèses des membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
...
\section{Catalogues d'exposition}
\printbibliography[heading=subbibliography,keyword=expo-crh,heading=none]

\newpage

\section{Outils pour la recherche}
\printbibliography[heading=subbibliography,keyword=outil-recherche-crh,heading=none]

\newpage

\section{Rapports}
\printbibliography[heading=subbibliography,keyword=report-crh,heading=none]

\newpage

\section{Articles dans un rapport}
\printbibliography[heading=subbibliography,keyword=art-rapport-crh,heading=none]

\newpage

\section{Conférences}
\printbibliography[heading=subbibliography,keyword=conf-crh,heading=none]

\newpage

\section{Thèses}
\printbibliography[heading=subbibliography,keyword=theses-crh,heading=none]
