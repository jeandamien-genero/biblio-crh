...
% BIB SOURCE
\addbibresource{../compterendu.bib}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les comptes rendus publiés par les membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
