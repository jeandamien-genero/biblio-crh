...
\title{Bibliographie rétrospective du CRH (articles)}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les articles écrits par les membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
...
\begin{center}
	\section*{\textsc{Articles de revue}}
\end{center}
