...
% BIB SOURCE
\addbibresource{../../retro-biblio/articles_revues.bib}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les articles des membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
