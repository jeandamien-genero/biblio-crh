...
\begin{center}
	\begin{itshape}
				...
				Ce document \LaTeX{} présente les monographies des membres du CRH. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
