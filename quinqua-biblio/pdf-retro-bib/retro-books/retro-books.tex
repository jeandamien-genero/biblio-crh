...
\addbibresource{../monographies.bib}
...
\title{Bibliographie rétrospective du CRH (monographies)}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les monographies écrits par les membres du CRH de 1966 à 1997. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
...
\printbibliography[heading=subbibliography,keyword=book-crh,heading=none]

\newpage

\section{Rééditions}
\printbibliography[heading=subbibliography,keyword=reedition-crh,heading=none]
