...
\title{Bibliographie rétrospective du CRH (directions d'ouvrage)}
...
\begin{center}
	\begin{itshape}
		...
		Ce document \LaTeX{} présente les ouvrages dirigés par les membres du CRH de 1966 à 1997. Le fichier \hologo{BibTeX} contenant l'ensemble des données est également disponible.
