...
\DeclareFieldFormat[inbook]{booktitle}{\textit{#1}\addcomma\addspace}
...
% nouveau delimiteur entre l'auteur et le titre :
% \DeclareDelimFormat[bib]{nametitledelim}{<nouveau delimiteur>}
...
Coordination par Cécile Soudan (ingénieure de recherche du CNRS)

et Jean-Damien Généro (ingénieur d'études du CNRS).
...
Saisie et suivi du projet : Cécile Soudan, Jean-Damien Généro,

Francine Filoche (technicienne de l'EHESS)

et Caroline Long Baros (assistante ingénieure de l'EHESS).
